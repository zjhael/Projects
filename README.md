# AWS EKS Project Deployed a 2048 game app on an EKS Fargate cluster using `eksctl`, `kubectl`, Helm, and AWS CLI. Configured IAM and OIDC for the AWS Load Balancer Controller and exposed the app via ALB Ingress.
